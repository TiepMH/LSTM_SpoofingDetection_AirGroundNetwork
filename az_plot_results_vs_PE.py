...
power_B = 0.05  # Watts
M_Bobs = 4
power_E_list = [0.01, 0.03, 0.05]  # Watts
N_Eves = M_Bobs - 2
n_anten_Alice = 6
# RIS
K_RIS = 8
...
colors = ['k', 'b', 'r', 'g', 'm']
fig = plt.figure()
for i in range(len(power_E_list)):
    power_E = power_E_list[i]
    n_time_steps_IN = 15
    n_steps_OUT = 5
...
""" Save figures """
# fig.savefig('saved_figs/' + 'ROC_vs_PE.png', dpi=300)

# ===================================================
""" Illustration: TPR vs TNR """
...
for i in range(len(power_E_list)):
    ...
    ax[0].plot(scaling_list, acc_H0_mean_arr,
               ...
               label='$P_E =$ %(first).0f mW' % {"first": power_E*1000})
...
""" Save figures """
# fig.savefig('saved_figs/' + 'TPR_and_TNR_vs_factor_and_PE.png', dpi=300)
...
""" Save figures """
# fig.savefig('saved_figs/' + 'Acc_vs_factor_and_PE.png', dpi=300)